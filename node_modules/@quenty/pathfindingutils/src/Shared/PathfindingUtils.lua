...
function PathfindingUtils.promiseComputeAsync(path: Path, start: Vector3, finish: Vector3): any
...
function PathfindingUtils.promiseCheckOcclusion(path: Path, startIndex: number): any
